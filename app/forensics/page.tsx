...
import { ShieldAlert, Activity, ShieldCheck, AlertTriangle, Moon, Sun, Globe, Upload, Link as LinkIcon, Type, FileImage, CheckCircle, X, RefreshCw } from 'lucide-react';
    ...
    <div className="font-body-md min-h-screen flex flex-col relative overflow-x-hidden">
        ...
        <nav className="bg-surface/80 backdrop-blur-md font-headline-sm text-headline-sm text-mono-label border-b border-outline-variant shadow-[0_0_15px_rgba(76,215,246,0.1)] fixed top-0 left-0 w-full z-50 flex justify-between items-center px-margin-desktop py-4">
            ...
            <div className="hidden md:flex items-center gap-8 font-mono-label text-mono-label">
                ...
                <Link className="text-primary border-b-2 border-primary pb-1 active:scale-95 transition-transform" href="/forensics">Forensics</Link>
                    ...
                    <AnimatePresence>
                        {isAnalyzing && (
                            ...
                            >
                                ...
                                <div className="font-mono text-primary text-sm font-bold tracking-widest text-center space-y-2">
                                    ...
                                    <p className="opacity-70">&gt; CROSS-REFERENCING DOMAIN HEADERS...</p>
                                </div>
                            </motion.div>
                        )}
                        ...
                        {result && !isAnalyzing && (
                            ...
                            >
                                ...
                                <div className="bg-surface dark:bg-[#020617] border border-tertiary/30 p-6 rounded flex items-center justify-between mb-6 shrink-0">
                                    <div>
                                        <div className="font-mono-label text-xs font-bold text-on-surface-variant mb-2">THREAT LEVEL</div>
                                        <div className="font-display-lg text-4xl font-bold text-error leading-none">CRITICAL</div>
                                    </div>
                                    <div className="text-right">
                                         <div className="font-mono-label text-xs font-bold text-on-surface-variant mb-2">SCAM PROBABILITY</div>
                                         <div className="font-display-lg text-4xl font-bold text-error leading-none">{result.scam_probability}%</div>
                                    </div>
                                </div>
